            ...
            <div class="table-responsive-sm">
                    <table class="table table-borderless tab">
                        ...
                        <tr>
                            ...
                            <td><small>Email Address &nbsp; <a href="#">Change</a> </small></td>
                            <td><small>Mobile &nbsp; <a href="#">Change</a> </small></td>
        ...
        <div class="BTNS">
            <div class="table-responsive-sm">
                    <table class="table table-borderless tab">
                        ...
                        <tbody>
                        <tr>
                            <td><a href="editprofile.php" class="btn btn-info st">Edit Profile</a> </td>
                        </tr>
                         <tr>
                            <td><a href="changepass.php" class="btn btn-info st">Change Password</a></td>
                        </tr>
                        </tbody>
                </table>
        </div>
