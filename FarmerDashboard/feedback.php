...
<div class="page-row page-row-expanded">
    ...
    <!-- Feedback  -->
    <section class="bg-white p-5" id="feedback">
        <div class="container-fluid ">
            <!-- title -->
            <div class="row">
                <div class="col text-center mb-3">
                    <h1 class="display-4  text-warning">Feedback</h1>
                    <p class="lead text-secondary">Your feedbacks makes our team to work harder for you.</p>
            ...
            <div class="row justify-content-center">
                ...
                <label id="fdbck" class="fdbck" ><span style="color:green;text-align:center;">Feedbacck submitted successfully!</span></label>
                    ...
                    <form method="post" action="" class="text-muted">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" name="submit" class="btn btn-outline-warning btn-block mt-4">Submit</button>
        ...
        <?php
            ...
            if(isset($_POST['submit'])) {
                ...
                $curdate = " select current_date() from feedback ";
                $da = mysqli_query($con,$curdate);
                while($array = mysqli_fetch_array($da)) {
                ...
                $fd = "insert into notification(note, type ) values('$note', '$type') ";
                mysqli_query($con,$fd);
                
                ?>
                <script>
            document.querySelector('.fdbck').style.display = 'flex';
            </script>
                <?php
            }
