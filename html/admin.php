...
<head>
    ...
    <title>FTVM 's Admin Dashboard </title>
</head>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                        <a href="#"
                            class="navbar-brand text-white d-block mx-auto text-center py-3 mb-4 bottom-border">FTVM</a>
                        <div class="bottom-border pb-3">
                            <img src="../image/Mahboob.jpg" width="50" class="rounded-circle mr-3">
                            <a href="#" class="text-white">Mahboob Hazraty</a>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-block bg-secondary text-light text-left"
                                            ...
                                            <img src="../image/cust1.jpeg" width="50" class="mr-3 rounded">
                                    ...
                                    <div class="collapse show" id="collapseOne" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            modi delectus fugiat consectetur eaque harum obcaecati, saepe id vitae,
                                            dolore aliquam! Quos, doloribus quisquam.
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-block bg-secondary text-light text-left"
                                            ...
                                            <img src="../image/cust2.jpeg" width="50" class="mr-3 rounded">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-block bg-secondary text-light text-left"
                                            ...
                                            <img src="../image/cust3.jpeg" width="50" class="mr-3 rounded">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-block bg-secondary text-light text-left"
                                            ...
                                            <img src="../image/cust4.jpeg" width="50" class="mr-3 rounded">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-block bg-secondary text-light text-left"
                                            ...
                                            <img src="../image/cust5.jpeg" width="50" class="mr-3 rounded">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-block bg-secondary text-light text-left"
                                            ...
                                            <img src="../image/cust6.jpeg" width="50" class="mr-3 rounded">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <button type="button"
                                                class="btn btn-block text-uppercase font-weight-bold text-light bg-info py-2 mb-5">Submit
                                                Post</button>
                                        </div>
                                    </form>
                                    <div class="row">
