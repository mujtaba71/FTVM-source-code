                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class=" d1">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <img class="imgicon" src="../image/icons/tot%20users.png" style="height:100px; width:100px;">
                                                </div>
                                                <?php
                                                include('../html/DBcon.php');
                                                $f = "select count(email) from usert";
                                                $g = mysqli_query($con,$f);
                                                $h = mysqli_fetch_array($g);
                                                
                                                ?>
                                                <div class="col-lg-6 tn">
                                                    <p class="txt"><?php echo $h['count(email)']; ?><br>Users</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" d1">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <img class="imgicon2" src="../image/icons/tot%20pro.png" style="height:100px; width:100px;">
                                                </div>
                                                <?php
                                                include('../html/DBcon.php');
                                                $i = "select count(name) from product";
                                                $j = mysqli_query($con,$i);
                                                $k = mysqli_fetch_array($j);
                                                
                                                ?>
                                                <div class="col-lg-6 tn">
                                                    <p class="txt"><?php echo $k['count(name)']; ?><br>Total Products</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class=" d1">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <img class="imgicon3" src="../image/icons/pending%20pro.png" style="height:100px; width:100px;">
                                                </div>
                                                <?php
                                                include('../html/DBcon.php');
                                                $l = "select count(name) from product where status != 'approved' ";
                                                $m = mysqli_query($con,$l);
                                                $n = mysqli_fetch_array($m);
                                                
                                                ?>
                                                <div class="col-lg-6 tn">
                                                    <p class="txt"><?php echo $n['count(name)']; ?><br>Pending Products</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class=" d1">
                                            <div class="row">
                                                <div class="col-lg-6 col-sm-8">
                                                    <img class="imgicon4" src="../image/icons/approved.png" style="height:100px; width:100px;">
                                                </div>
                                                <?php
                                                include('../html/DBcon.php');
                                                $o = "select count(name) from product where status = 'approved' ";
                                                $p = mysqli_query($con,$o);
                                                $q = mysqli_fetch_array($p);
                                                
                                                ?>
                                                <div class="col-lg-6 col-sm-8 tn">
                                                    <p class="txt"><?php echo $q['count(name)']; ?><br>Approved Products</p>
                                                </div>
                                            </div>
