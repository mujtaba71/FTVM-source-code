                                      ...
                                      <tbody>
                                         <?php
                                          ...
                                          <tr style="height:30px;">
                                              <td> <strong>Name:</strong> <small><?php echo $fl['name'] ?></small></td>
                                              <td class="w"><small><?php echo $fl['cur_date'] ?></small></td>
                                              
                                          </tr>
                                        
                                          <tr class="two">
                                              <td style="width: 400px;"><strong>Subject:</strong> <?php echo $fl['subject'] ?> </td>
                                              
                                          </tr>
                                          <tr>
                                             
                                              <td class="clear" style="width: 400px;">
