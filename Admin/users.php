     ...
     ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="users.php?reject=<?php echo $row_pro['email']?>"><i class="fas fa-trash-alt" style="color:red"></i> </a>
                                        </td>
            ...
            ?>
                        ...
                        include("../html/DBcon.php");
                          ...
                          if(isset($_GET['reject'])) {
                             ...
                             $a = " delete from usert where email = '$_GET[reject]'";
                             mysqli_query($con, $a);
                             $b = " delete from product where u_email = '$_GET[reject]'";
                             mysqli_query($con, $b);
                             $c = " delete from bids where u_email = '$_GET[reject]'";
                             mysqli_query($con, $c);
                             $d = " delete from sold_product where b_email = '$_GET[reject]'";
                             mysqli_query($con, $d);
                             $e = " delete from shopping_cart where u_email = '$_GET[reject]'";
                             mysqli_query($con, $e);
